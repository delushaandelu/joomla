...
class Helix3FeatureContact {
	...
	public function renderFeature() {
		...
		if($this->helix3->getParam('enable_contactinfo')) {
            ...
            if($this->helix3->getParam('contact_time')) $output .= '<li class="sp-contact-time"><i class="fa fa-clock-o"></i> <a href="time:'. $this->helix3->getParam('contact_time') .'">' . $this->helix3->getParam('contact_time') . '</a></li>';
