	...
	public function renderFeature() {
		...
		if( $this->helix3->getParam('logo_type') == 'image' ) {
			if( $this->helix3->getParam('logo_image') ) {
				...
				$html .= '<h1>';
				$html .= '<img class="sp-default-logo hvr-wobble-horizontal'. $custom_logo_class .'" src="' . $this->helix3->getTemplateUri() . '/images/presets/' . $this->helix3->Preset() . '/logo.png" alt="'. $sitename .'">';
