<?php
/**
 * @version   $Id: Quotes.php 19249 2014-02-27 19:21:50Z btowles $
 * @author    RocketTheme http://www.rockettheme.com
 * @copyright Copyright (C) 2007 - 2015 RocketTheme, LLC
 * @license   http://www.gnu.org/licenses/gpl-2.0.html GNU/GPLv2 only
 */

class RokSprocketSiteLayoutAjaxModelQuotes extends RokSprocket_AbstractAjaxRenderingLayoutModel
{
	/**
	 * @param $params
	 * {
	...
	public function getPage($params)
	{
		...
		try {
			...
			$layout_lib_path = $container['roksprocket.layouts.quotes.library.paths'];
			...
			$layout = $container->getService('roksprocket.layout.quotes');
			...
			$offset       = ($params->page - 1) * $module_params->get('quotes_items_per_page', 1);
			$items        = $items->slice($offset, $module_params->get('quotes_items_per_page', 1));
