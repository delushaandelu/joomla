<?php
/**
 * @version   $Id: Tables.php 19249 2014-02-27 19:21:50Z btowles $
 * @author    RocketTheme http://www.rockettheme.com
 * @copyright Copyright (C) 2007 - 2015 RocketTheme, LLC
 * @license   http://www.gnu.org/licenses/gpl-2.0.html GNU/GPLv2 only
 */

class RokSprocketSiteLayoutAjaxModelTables extends RokSprocket_AbstractAjaxRenderingLayoutModel
{
	/**
	 * @param $params
	 * {
	...
	public function getPage($params)
	{
		...
		try {
			...
			$layout_lib_path = $container['roksprocket.layouts.tables.library.paths'];
			...
			$layout = $container->getService('roksprocket.layout.tables');
			...
			$offset       = ($params->page - 1) * $module_params->get('tables_items_per_page', 1);
			$items        = $items->slice($offset, $module_params->get('tables_items_per_page', 1));
