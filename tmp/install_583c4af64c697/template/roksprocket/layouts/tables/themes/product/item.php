...
<li class="sprocket-tables-block <?php echo $item->getParam('tables_item_class'); ?>" data-tables-item>
	<div class="sprocket-tables-item" data-tables-content>
		<?php if ($item->getPrimaryImage()) :?>
			<img src="<?php echo $item->getPrimaryImage()->getSource(); ?>" class="sprocket-tables-image" alt="<?php echo $item->getPrimaryImage()->getAlttext(); ?>" />
		<?php endif; ?>
		...
		<div class="sprocket-tables-link sprocket-tables-cell sprocket-tables-bg1">
			<a href="<?php echo $item->getPrimaryLink()->getUrl(); ?>" class=" btn btn-primary"><?php echo $item->getParam('tables_item_link_text'); ?></a>
		</div>
		<?php endif; ?>
	</div>
</li>
