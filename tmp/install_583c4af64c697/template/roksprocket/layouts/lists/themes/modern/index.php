...
?>
<div class="sprocket-lists-modern" data-lists="<?php echo $parameters->get('module_id'); ?>">
	...
	<div class="sprocket-lists-modern-nav">
		<div class="sprocket-lists-modern-pagination<?php echo !$parameters->get('lists_show_pagination') || $pages <= 1 ? '-hidden' : '';?>">
			<ul>
