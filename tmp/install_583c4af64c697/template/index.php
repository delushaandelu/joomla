...
<head>
    ...
    $this->helix3->addCSS('bootstrap.min.css, font-awesome.min.css, hover-min.css, animate.css, uikit.almost-flat.css') // CSS Files
        ->addJS('bootstrap.min.js, jquery.sticky.js, main.js, wow.min.js, custom.js, jquery.elevatezoom.js, uikit.min.js, scrollReveal.min.js') // JS Files
